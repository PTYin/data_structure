...
namespace pty
{
    ...
    protected:
        ...
        explicit Node(const T &_value, Node *_father = nullptr, Node *_left_child = nullptr,
                      Node *_right_child = nullptr) :
                value(_value), father(_father), left_child(_left_child), right_child(_right_child), LTag(false),
                RTag(false)
        {}
